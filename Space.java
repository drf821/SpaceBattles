    ...
    public Space(int level, int difficulty) {
        ...
        switch (level + 1) {
            case 1:
            	...
            	spaceList.add(new EnemySpaceShip(960, 100, 270, f));
                break;
            case 2:
...
//                spaceList.add(new EnemySpaceShip(270, 1200, 200, 0, new Polygon(), f));
            	spaceList.add(new EnemySpaceShip(720, 200, 270, f));
                spaceList.add(new EnemySpaceShip(1200, 200, 270, f));
                break;
            case 3:
...
//                spaceList.add(new EnemySpaceShip(270, 1600, 200, 0, new Polygon(), f));
            	spaceList.add(new EnemySpaceShip(320, 200,  270,f));
                spaceList.add(new EnemySpaceShip(960, 100, 270, f));
                spaceList.add(new EnemySpaceShip(1600, 200, 270, f));
                break;
            case 4:
...
//                spaceList.add(new EnemySpaceShip(270, 1600, 100, 0, new Polygon(),  f));
                ...
                spaceList.add(new EnemySpaceShip(320, 100,  270, f));
                spaceList.add(new EnemySpaceShip(640, 200, 270, f));
                spaceList.add(new EnemySpaceShip(1280, 200, 270, f));
                spaceList.add(new EnemySpaceShip(1600, 100, 270,  f));
                break;
            case 5:
...
//                spaceList.add(new EnemySpaceShip(270, 1600, 250, 0, new Polygon(), f));
            	 spaceList.add(new EnemySpaceShip(320, 250, 270, f));
                 spaceList.add(new EnemySpaceShip(640, 200, 270, f));
                 spaceList.add( new EnemySpaceShip(960, 100, 270, f));
                 spaceList.add(new EnemySpaceShip(1280, 200, 270, f));
                 spaceList.add(new EnemySpaceShip(1600, 250, 270, f));
