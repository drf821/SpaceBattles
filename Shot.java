...
public class Shot extends SpaceProjectile {
    ...
    public void startProjectile() {
        super.setxPosition((int) (super.getxPosition() - (Math.cos(Math.toRadians(super.getDirection())) * (75 * super.getSize()))));
        super.setyPosition((int) (super.getyPosition() - (Math.sin(Math.toRadians(super.getDirection())) * (75 * super.getSize()))));
